...
For a list of available region flags, refer to the [Region Flags section](https://github.com/Chalwk77/JeriCraftDocs/blob/main/docs/guides/features/Main.md) in the Main documentation.
